...
/**
 * Parse a "YYYY-MM-DD" date string in LOCAL timezone (no UTC shift)
 ...
 * @param {string} dateStr — "YYYY-MM-DD" string from date input
...
export const isOverdue = (dateStr) => {
  ...
  const date = parseDateLocal(dateStr); // already at local midnight
  const now = new Date();
